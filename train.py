...
if __name__ == '__main__':
    ...
    opt['dataset'] = 'Fuji'      # SID/MCR dataset
    ...
    if opt['dataset'] == 'Fuji':
        train_input_paths = glob.glob(os.path.join('/home/featurize/data/Fuji/short/0*_00_0.1s.RAF')) + glob.glob(os.path.join('/home/featurize/data/Fuji/short/2*_00_0.1s.RAF'))
        train_gt_paths = []
        for x in train_input_paths:
            train_gt_paths += glob.glob(os.path.join('/home/featurize/data/Fuji/long/*' + x[-17:-12] + '*.RAF'))

        test_input_paths = glob.glob(os.path.join('/home/featurize/data/Fuji/short/1*_00_0.1s.RAF'))
        test_gt_paths = []
        for x in test_input_paths:
            test_gt_paths += glob.glob(os.path.join('/home/featurize/data/Fuji/long/*' + x[-17:-12] + '*.RAF'))
